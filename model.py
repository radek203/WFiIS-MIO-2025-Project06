...
# Specjalna wersja modelu dla mniejszych zbiorów danych, takich jak Iris.
# W przypadku takich zbiorów konieczne było zmniejszenie udziału danych testowych (test_size=0.10),
class ModelForSmallDatasets:
    ...
    def learn(self, X, y, early_stopping=-1, augment=False):
        ...
        # Podział na zbiory treningowy i testowy
        X_train, X_test, y_train, y_test = train_test_split(
            X_scaled, y_cat, test_size=0.10, stratify=y_encoded, random_state=42
        )
