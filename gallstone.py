...
def calc():
    ...
    # Wykresy
    draw_plots(history_basic, history_dropout, 'basic', 'dropout', 'gallstone')
    draw_plots(history_basic, history_l1, 'basic', 'l1', 'gallstone')
    draw_plots(history_basic, history_l2, 'basic', 'l2', 'gallstone')
    draw_plots(history_basic, history_early_stopping, 'basic', 'early_stopping', 'gallstone')
    draw_plots(history_basic, history_simplified, 'basic', 'simplified', 'gallstone')
    draw_plots(history_basic, history_augment, 'basic', 'augment', 'gallstone')
    draw_plots(history_basic, history_l1_l2_dropout, 'basic', 'l1_l2_dropout', 'gallstone')
    draw_plots(history_basic, history_l2_dropout, 'basic', 'l2_dropout', 'gallstone')