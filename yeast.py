...
def calc():
    ...
    draw_plots(history_basic, history_dropout, 'basic', 'dropout', 'yeast', output_dir='results/yeast')
    draw_plots(history_basic, history_l1, 'basic', 'l1', 'yeast', output_dir='results/yeast')
    draw_plots(history_basic, history_l2, 'basic', 'l2', 'yeast', output_dir='results/yeast')
    draw_plots(history_basic, history_early_stopping, 'basic', 'early stopping', 'yeast', output_dir='results/yeast')
    draw_plots(history_basic, history_simplified, 'basic', 'simplified', 'yeast', output_dir='results/yeast')
    draw_plots(history_basic, history_augment, 'basic', 'augment', 'yeast', output_dir='results/yeast')
    draw_plots(history_basic, history_l1_l2_dropout, 'basic', 'l1_l2_dropout', 'yeast', output_dir='results/yeast')
